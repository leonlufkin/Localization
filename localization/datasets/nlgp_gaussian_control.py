...
class NLGPGaussianControlDataset(Dataset):
...
if __name__ =="__main__":
    ...
    control_dataset = NLGPGaussianControlDataset(key=key, xi1=xi1, xi2=xi2, gain=gain, num_dimensions=40, num_exemplars=10000)
